  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <hr class="my-3 ">
          <li class="nav-item {{ Nav::isRoute('manage.dashboard') }} ">
            <a class="nav-link " href="{{route('manage.dashboard')}}">
              <i class="ni ni-tv-2 text-primary"></i> Dashboard
            </a>
          </li>
          <hr class="my-3">
          <h6 class="navbar-heading text-muted">Content</h6>
           <li class="nav-itemc {{ Nav::isRoute('posts.index') }}">
            <a class="nav-link" href="{{route('posts.index')}}">
              <i class="ni ni-bullet-list-67 text-red"></i> Posts
            </a>
          </li>
          <hr class="my-3">
          ...
          <li class="nav-item {{ Nav::isRoute('users.index') }}">
            <a class="nav-link" href="{{route('users.index')}}">
              <i class="ni ni-planet text-blue"></i> Manage Users
            </a>
          </li>
